<template>
  ...
  >
    ...
    <button
      class="bg-soft-blue w-60 text-white py-2 px-7 rounded-md hover:bg-transparent hover:text-soft-blue hover:shadow-none border-soft-blue border-2 shadow-md smooth"
    >
